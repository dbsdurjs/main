...
# -*- coding: utf-8 -*-
"""
LLM Comparator - 공식 클러스터링 포함 완전 버전
패치된 라이브러리를 사용하여 공식 클러스터링 실행
"""
...
output_file = f"{output_dir}/llm_comparator_official_complete_{timestamp}.json"
...
print(f"\n💡 개선 사항:")
print(f"  ✅ LLM Comparator 공식 라이브러리 사용")
print(f"  ✅ 패치된 클러스터링으로 버그 해결")
print(f"  ✅ Individual rater scores 포함")
print(f"  ✅ Rationale 포함")
print(f"  ✅ 클러스터링 포함")
print(f"  ✅ LLM Comparator 표준 형식 준수")
